<script lang="ts">
	// IMPORTANT: Attempting to just copy the wallet-adapter-ui package
	// so I can make customize.
	// REF: https://github.com/svelte-on-solana/wallet-adapter/tree/master/packages/ui
  // NOTE: Going to add a wallet.css file with custom Skeleton styling, then
  // going to add to WalletMultiButton
  // REF: https://solana.stackexchange.com/a/4242/1287
...
{#if !wallet}
	<WalletButton class="wallet-adapter-button-trigger wallet-button-custom" on:click={openModal}>
